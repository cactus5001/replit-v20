/*
  # Complete Healthcare Super-App Database Schema
...
INSERT INTO medicines (name, description, price, stock_quantity, category, image_url) VALUES
  ...
  ('Aspirin 325mg', 'Pain reliever and blood thinner. Consult doctor for regular use.', 9.99, 90, 'Pain Relief', 'https://images.pexels.com/photos/3683107/pexels-photo-3683107.jpeg'),
  ('Omeprazole 20mg', 'Proton pump inhibitor for acid reflux and heartburn.', 22.50, 60, 'Digestive', 'https://images.pexels.com/photos/3683107/pexels-photo-3683107.jpeg'),
  ('Loratadine 10mg', 'Non-drowsy antihistamine for seasonal allergies.', 11.25, 85, 'Allergy', 'https://images.pexels.com/photos/3683107/pexels-photo-3683107.jpeg')
...
DROP TRIGGER IF EXISTS update_ambulance_requests_updated_at ON ambulance_requests;
